...
from skimage.util import rescale_as_float, random_noise

test_img = rescale_as_float(camera())
test_img_color = rescale_as_float(chelsea())
test_img_3d = rescale_as_float(binary_blobs(64, n_dim=3)) / 2
